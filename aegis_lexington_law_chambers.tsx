...
export default function App() {
  ...
  const [portalEmail] = useState('sterling.ventures@client.com');
  const [portalPassword] = useState('••••••••');
  ...
  const calculatedSettlement = useMemo(() => {
    ...
    const netPayout = gross - attorneyFees;
  ...
  const evaluateCaseViability = (answers) => {
    const { timeframe, evidence, lossValue } = answers;
    let score = 0;

    if (timeframe === 'recent') score += 3;
    if (timeframe === 'mid') score += 2;
    if (timeframe === 'old') score += 0;

    if (evidence === 'strong') score += 4;
    if (evidence === 'partial') score += 2;
    if (evidence === 'none') score += 0;

    if (lossValue === 'high') score += 3;
    if (lossValue === 'medium') score += 2;
    if (lossValue === 'low') score += 1;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 font-sans text-xs tracking-wider uppercase font-bold">
                <a
                  href="#priority-booking"
                  className="bg-gradient-to-r from-[#8C6D1F] to-[#C59B27] text-white px-8 py-4 text-center border border-amber-300 hover:scale-101 hover:shadow-lg transition-all"
                >
                  Schedule Strategy Session
                </a>
                <a
                  href="#practice-areas"
                  className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border border-gray-300 dark:border-slate-700 px-8 py-4 text-center hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
                >
      ...
      <section id="practice-areas" className="py-20 bg-gray-50 dark:bg-[#0F141F] transition-colors border-b border-gray-150 dark:border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center space-x-2 sm:space-x-4 overflow-x-auto pb-4 mb-8 font-sans text-xs tracking-wider uppercase font-bold">
            {PRACTICE_AREAS.map((pa) => (
              <button
                ...
                onClick={() => {
                  setActiveTab(pa.id);
                  triggerToast(`Selected practice division: ${pa.title}`, 'info');
                }}
                className={`px-5 py-3 rounded-none transition-all whitespace-nowrap ${
                  activeTab === pa.id
          ...
          <div className="bg-white dark:bg-[#101625] border border-gray-150 dark:border-slate-850 p-8 sm:p-12 shadow-xl">
            {PRACTICE_AREAS.filter(pa => pa.id === activeTab).map((pa) => (
              <div key={pa.id} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-7 space-y-6">
                  ...
                  <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-slate-800">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {pa.highlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-center space-x-2 text-xs font-sans text-gray-700 dark:text-slate-300">
                ...
                <div className="lg:col-span-5 bg-gray-50 dark:bg-[#0B0F19] p-6 border-l-4 border-[#C59B27] space-y-4">
                  ...
                  <a
                    href="#priority-booking"
                    onClick={() => setBookingForm(prev => ({ ...prev, practiceArea: pa.id }))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {ATTORNEYS.map((attorney) => (
              <div 
                key={attorney.id} 
                className="bg-gray-50 dark:bg-[#101625] border border-gray-150 dark:border-slate-850 shadow-md group overflow-hidden flex flex-col justify-between"
              >
                <div>
                  {/* Portrait Section */}
                ...
                <div className="p-5 pt-0">
                  <a
                    ...
                    onClick={() => {
                      setBookingForm(prev => ({
                        ...prev,
                        summaryText: `Preferred counsel: Partner ${attorney.name}. Corporate / Private strategic inquiry.`
                      }));
                      triggerToast(`Routing strategy direct to ${attorney.name}'s chamber administrative clerk.`, 'success');
                    }}
            ...
            <div className="lg:col-span-7 bg-white dark:bg-[#101625] border border-gray-150 dark:border-slate-850 p-6 sm:p-8 shadow-xl space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-3 font-sans text-xs">
                  <button
                    onClick={() => setCalcType('contract')}
                    className={`py-3 text-center rounded-none font-bold uppercase transition-all ${
                      calcType === 'contract'
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  step="25000"
                  value={directDamages} 
                  onChange={(e) => setDirectDamages(Number(e.target.value))}
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-[#0F141F] to-[#1A2335] border border-[#C59B27]/30 text-slate-100 p-8 shadow-2xl space-y-6">
              ...
              <a
                ...
                onClick={() => {
                  setBookingForm(prev => ({
                    ...prev,
                    summaryText: `Litigation category selected: ${calcType.toUpperCase()} with estimated direct value of $${Number(directDamages).toLocaleString()}. Requesting strategic evaluation.`
                  }));
          ...
          <div className="bg-gray-50 dark:bg-[#101625] border border-gray-150 dark:border-slate-850 p-6 sm:p-10 shadow-xl space-y-8">
            ...
            <div className="relative">
              ...
              <div className="flex justify-between items-center text-xs font-sans mb-8">
                {['Category', 'Timeline', 'Proof', 'Value', 'Report'].map((label, idx) => (
              ...
              {quizStep === 0 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <button 
                      onClick={() => handleQuizAnswer('category', 'corporate')}
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('category', 'patent')}
                      className="p-5 text-left border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#C59B27] transition-all flex justify-between items-center font-sans font-bold"
                    >
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('category', 'contract')}
                      className="p-5 text-left border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#C59B27] transition-all flex justify-between items-center font-sans font-bold"
                    >
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('category', 'trust')}
                      className="p-5 text-left border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#C59B27] transition-all flex justify-between items-center font-sans font-bold"
                    >
              ...
              {quizStep === 1 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 font-sans font-bold">
                    <button 
                      onClick={() => handleQuizAnswer('timeframe', 'recent')}
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('timeframe', 'mid')}
                      className="p-5 text-left bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 hover:border-[#C59B27] flex justify-between items-center"
                    >
                      <div>
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('timeframe', 'old')}
                      className="p-5 text-left bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 hover:border-[#C59B27] flex justify-between items-center"
                    >
                      <div>
              ...
              {quizStep === 2 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-3 font-sans font-bold">
                    <button 
                      onClick={() => handleQuizAnswer('evidence', 'strong')}
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('evidence', 'partial')}
                      className="p-5 text-left bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 hover:border-[#C59B27] flex justify-between"
                    >
                      <div>
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('evidence', 'none')}
                      className="p-5 text-left bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 hover:border-[#C59B27] flex justify-between"
                    >
                      <div>
              ...
              {quizStep === 3 && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3 font-sans text-xs">
                    <button 
                      onClick={() => handleQuizAnswer('lossValue', 'high')}
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('lossValue', 'medium')}
                      className="p-5 border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#C59B27] text-center flex flex-col items-center space-y-2 font-bold"
                    >
                      <span className="text-2xl">💼</span>
                      <span>$50k - $250k</span>
                    ...
                    <button 
                      onClick={() => handleQuizAnswer('lossValue', 'low')}
                      className="p-5 border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-[#C59B27] text-center flex flex-col items-center space-y-2 font-bold"
                    >
                      <span className="text-2xl">📉</span>
                      <span>Below $50k</span>
                ...
                <div className="space-y-6 text-center">
                  ...
                  <div className="flex justify-center space-x-3 pt-4">
                    <button
                      ...
                      className="border border-gray-300 dark:border-slate-700 font-sans text-xs uppercase tracking-wider font-bold py-3 px-6 text-slate-800 dark:text-slate-200"
                    >
                      Reset Evaluation
                    </button>
                    <a
                      ...
                      onClick={() => {
                        setBookingForm(prev => ({
                          ...prev,
                          summaryText: `Auto Evaluation completed. Case Viability: ${quizResult.title}. Evidence: ${quizAnswers.evidence.toUpperCase()}. Timeframe: ${quizAnswers.timeframe.toUpperCase()}.`
                        }));
                  ...
                  <div className="space-y-3 bg-gray-50 dark:bg-[#0B0F19] p-4 border border-gray-150 dark:border-slate-850">
                    ...
                    <div className="space-y-3 max-h-44 overflow-y-auto pr-2 scrollbar-thin text-xs font-sans">
                      {portalMessages.map((msg, idx) => (
                        <div 
                          key={idx} 
                          className={`p-3 max-w-sm rounded-none border ${
                            msg.sender === 'You' 
                    ...
                    <form onSubmit={handleSendPortalMsg} className="flex gap-2 pt-2 border-t border-gray-150 dark:border-slate-800">
                      <input 
                        type="text"
                        placeholder="Inquire securely on this draft folder..."
                        value={newPortalMsg}
                      ...
                      <button 
                        type="submit"
                        className="bg-[#C59B27] text-white font-sans text-xs uppercase tracking-wider font-bold py-2.5 px-4"
                      >
                        Send
                      </button>
                    </form>
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-6 text-left font-sans text-xs text-slate-300">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="e.g., Andrew Kimani, Managing Director"
                ...
                <div>
                  ...
                  <input
                    type="email"
                    required
                    placeholder="e.g., andrew@ventures.com"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    type="date"
                    value={bookingForm.prefDate}
                    onChange={(e) => setBookingForm({...bookingForm, prefDate: e.target.value})}
                    className="w-full bg-[#0F141F] border border-slate-800 rounded-none py-3 px-4 text-slate-100 focus:outline-none focus:border-[#C59B27]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  placeholder="Identify opposing entity or strategic assets, documentation status, and immediate objectives..."
                  value={bookingForm.summaryText}
                  onChange={(e) => setBookingForm({...bookingForm, summaryText: e.target.value})}
                  className="w-full bg-[#0F141F] border border-slate-800 rounded-none py-3 px-4 text-slate-100 focus:outline-none focus:border-[#C59B27]"
                  rows="3"
                />
              </div>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#8C6D1F] to-[#C59B27] hover:from-[#735817] hover:to-[#B08920] text-slate-100 font-extrabold py-4 px-8 rounded-none transition-all tracking-wider uppercase border border-amber-300"
                >
          ...
          <div className="space-y-4 font-sans text-xs">
            {FAQS.map((faq, index) => {
              ...
              return (
                <div 
                  key={index} 
                  className="bg-white dark:bg-[#101625] border border-gray-150 dark:border-slate-850 shadow-sm transition-all"
                >
                  <button
                    onClick={() => {
                      setIsOpen(!isOpen);
                      triggerToast(`Browsed instruction framework: Q${index + 1}`, 'info');
                    }}
                  ...
                  >
                    ...
                    <span className={`text-lg font-light transform transition-transform duration-200 ${isOpen ? 'rotate-45 text-[#C59B27]' : 'text-gray-400'}`}>
                      +
                    </span>
                  </button>

                  <div className={`transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-56' : 'max-h-0'}`}>
            ...
            <div className="lg:col-span-7 h-[350px] lg:h-[450px] relative rounded-none overflow-hidden border border-gray-150 dark:border-slate-800 shadow-lg bg-gray-50 dark:bg-slate-900 flex flex-col items-center justify-center text-center p-6">
              ...
              <div className="relative z-10 space-y-4 max-w-sm font-sans">
                ...
                <div className="flex justify-center space-x-3 text-xs font-bold">
                  ...
                  <a
                    href="https://wa.me/254711999888"
                    className="bg-[#0B4F30] text-white py-2.5 px-4"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12 font-sans text-xs">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs text-gray-500">
              <li><a href="#practice-areas" onClick={() => setActiveTab('corporate')} className="hover:text-[#C59B27] transition-colors">Corporate Mergers & Restructure</a></li>
              <li><a href="#practice-areas" onClick={() => setActiveTab('litigation')} className="hover:text-[#C59B27] transition-colors">Complex Civil Arbitration</a></li>
              <li><a href="#practice-areas" onClick={() => setActiveTab('estate')} className="hover:text-[#C59B27] transition-colors">Trust Administration & Wills</a></li>
              <li><a href="#practice-areas" onClick={() => setActiveTab('tech')} className="hover:text-[#C59B27] transition-colors">AI Regulatory Governance & Patents</a></li>
            </ul>
          </div>
